/**
 * Quoting the UPS / MOVIN export card.
 *
 * @deprecated This path is superseded by `/api/v1/ups/quotes`. It is kept alive permanently, not
 ...
 */
export { GET } from '../../v1/ups/quotes/route';
